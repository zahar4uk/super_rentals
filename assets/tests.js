...
define('super-rentals/tests/app.lint-test', [], function () {
  ...
  QUnit.test('routes/rentals/index.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/rentals/index.js should pass ESLint\n\n4:2 - Mixed spaces and tabs. (no-mixed-spaces-and-tabs)');
  });
...
define('super-rentals/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('unit/services/maps-test.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'unit/services/maps-test.js should pass ESLint\n\n1:10 - \'moduleFor\' is defined but never used. (no-unused-vars)');
  });
